...
const listeEmploye = async () => {
    try {
        const response = await axios.get("http://localhost:3000/employes/listetable");
...
const updateEmploye = async () => {
    try {
        await axios.patch(`http://localhost:3000/employes/modife/${edition.value}`, {
            nom: nom.value,
            prenom: prenom.value,
            sexe: sexe.value,
            motif: motif.value,
    ...
    <nav  aria-label="Page navigation example">
      <ul class="flex items-center -space-x-px h-20 text-sm">
        ...
        <li v-for="page in totalPages" :key="page">
          <a href="#" @click.prevent="goToPage(page)" :class="['flex items-center justify-center px-3 h-8 leading-tight', page === currentPage ? 'z-10 text-blue-600 border border-blue-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white' : 'text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white']">
            {{ page }}
          </a>
        </li>
        <li>
          <a href="#" @click.prevent="nextPage" class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
